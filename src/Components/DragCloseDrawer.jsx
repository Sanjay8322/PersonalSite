  ...
  return (
    <div className="">
      ...
      <motion.div
          ...
          >
          <a className='text-white font-bold tracking-wide text-xl ' onClick={() => setOpen(true)}>Know more</a>
        </motion.div>

      <DragCloseDrawer open={open} setOpen={setOpen}>
        <div className="mx-auto max-w-2xl space-y-4 text-white">
          <h2 className="text-4xl font-bold text-neutral-200">
            Who am I, What I do, What I want to be.
          </h2>
          <p>
          Hi, I'm Sanjay, a 23-year-old full-time software engineer. I love my job but I don't want to be doing this forever. I want to build something for my own. I have been creating content for about a year on X ( nothing really went viral yet.)

          my goal is before I turn to 25 I should have a personal brand & make $2k/month. Previously I built few micro products using No-code & nothing worked it end up I'm the one only use it. Currently I decided to focus on doing one thing that is website development for individuals & businesses. I learning & improving on it. Some of the sites I built are below on this site.


          I love about building products, listening to great entrepreneurs. My dream is to build a product that solves a real problem & it helps and makes people lives easier. 

          follow me on X @sn_jayy I write everyday about what I learn & my thoughts.
          </p>
      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="absolute bottom-0 h-[75vh] w-full overflow-hidden rounded-t-3xl bg-[#8C03FC] "
            style={{ y }}
            drag="y"
          ...
          >
            <div className="absolute left-0 right-0 top-0 z-10 flex justify-center bg-[#8C03FC]  p-4">
              <button
                onPointerDown={(e) => {
                  controls.start(e);
                }}
